...
class BalanceCalculator:
    ...
    def calculate(self, spec: dict) -> BalanceResult:
        ...
        # Get HSA growth rate from investments config
        ...
        for year in range(first_year, last_planning_year + 1):
            ...
            if year <= last_working_year:
                try:
                    ...
                    # Get employee HSA contribution (excluding employer contribution)
                    contrib_hsa = results['deductions'].get('employeeHSA', results['deductions']['maxHSA'])
                    ...
                    try:
                        ...
                        contrib_hsa = deductions.get('employeeHSA', deductions['maxHSA'])
                    except (KeyError, ValueError):
                        contrib_401k = 0
                        contrib_hsa = 0
                    deferred_contrib = 0
        ...
        return BalanceResult(
            ...
            final_hsa_balance=balance_hsa,
            total_retirement_assets=balance_401k + deferred_balance + balance_hsa
        )
